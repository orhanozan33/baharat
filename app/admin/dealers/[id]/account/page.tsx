...
import DealerAccountPage from '@/components/admin/DealerAccountPage'
import { serializeDealer } from '@/lib/serialize'

export default async function DealerAccountRoute({
  params,
}: {
  ...
  return <DealerAccountPage dealer={dealer} />
}
